...
//function to display the items of linklist :
void disp(){
...
// searching an item in the linklist:
void search(){
	int x,count=0;
...
// Delete an item from the linklist:
void deletion(){
	int choice;
...
// insert an item in the linklist maybe at beginning ,at end or at specific node:
void insertion(){
	int choice;
